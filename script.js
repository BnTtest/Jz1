...
const translations = {
  "pt-BR": {
    ...
    nav: {home:"Início",about:"Sobre",how:"Como Funciona",services:"Serviços",contact:"Contato",story:"Minha história",talk:"Falar com Jozy"},
    hero:{
    ...
    story:{kicker:"MINHA HISTÓRIA",title:"Eu também precisei aprender que treinar não era suficiente.",p1:"Eu já frequentava a academia, mas não levava minha alimentação a sério e, principalmente, não tinha estratégia. Eu treinava, mas treinava “fofo”. Minha alimentação também não tinha muito planejamento: eu comia sem muita consciência, não entendia bem minhas necessidades e não sabia como fazer a alimentação e o treino trabalharem juntos.",p2:"A mudança começou quando percebi que não bastava simplesmente ir à academia. Eu precisava entender o que estava colocando no prato, como organizar minha alimentação e como adaptar minhas escolhas aos meus objetivos. Foi quando minha alimentação deixou de ser algo secundário e passou a fazer parte da minha estratégia.",p3:"Nesse processo, comecei a estudar mais, aplicar o conhecimento na minha própria rotina e entender como alimentação, treino e consistência podem trabalhar juntos. Também aprendi que uma estratégia não precisa ser perfeita para funcionar — ela precisa fazer sentido para a vida real.",p4:"Hoje, como Nutrition Coach, quero compartilhar esse conhecimento e ajudar outras pessoas a encontrarem estratégias alimentares que se encaixem na sua rotina e nos seus objetivos."},
  ...
  "en-US": {
    ...
    nav:{home:"Home",about:"About",how:"How It Works",services:"Services",contact:"Contact",story:"My story",talk:"Talk to Jozy"},
    hero:{
    ...
    story:{kicker:"MY STORY",title:"I also had to learn that training alone was not enough.",p1:"I was already going to the gym, but I did not take my nutrition seriously and, most importantly, I had no strategy. I trained, but without enough intention. My eating habits also lacked planning: I ate without much awareness, did not fully understand my needs, and did not know how to make nutrition and training work together.",p2:"The change began when I realized that simply going to the gym was not enough. I needed to understand what I was putting on my plate, how to organize my nutrition, and how to adapt my choices to my goals. That was when nutrition stopped being secondary and became part of my strategy.",p3:"Throughout this process, I began studying more, applying that knowledge to my own routine, and understanding how nutrition, training, and consistency can work together. I also learned that a strategy does not need to be perfect to work — it needs to make sense in real life.",p4:"Today, as a Nutrition Coach, I want to share this knowledge and help others find nutrition strategies that fit their routines and goals."},
